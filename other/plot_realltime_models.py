...
if __name__ == '__main__':
    ...
    table = pd.read_pickle('../data/result/realtime_models_random.pkl')
    table = table.append(result_table, ignore_index=True)
    table.loc[9, 'model'] = "CatBoostClassifier"
    table.loc[9, 'random_state'] = 0
    table = table.drop(index=table[table['model'] == 'SGDClassifier'].index)
