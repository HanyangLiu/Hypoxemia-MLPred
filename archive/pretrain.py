...
def transition_model(timeSeriesTr, labelsTr, timeSeriesTe, labelsTe, args):
    ...
    train_data_generator = TransitionDataGenerator(timeSeriesTr, static_feat, labelsTr,
                                                   batch_size=batch_size,
                                                   window_size=window_size,
                                                   horizon=args.horizon,
                                                   shuffle=False)
    valid_data_generator = TransitionDataGenerator(timeSeriesTe, static_feat, labelsTe,
                                                   batch_size=batch_size,
                                                   window_size=window_size,
                                                   horizon=args.horizon,
                                                   shuffle=False)
