...
def multitask_rnn(window_size, n_features):
    ...
    predictor = layers.Dense(128, activation='relu')(encoder)
    ...
    model.compile(optimizer='adam', loss={'decoder1_output': 'mse',
                  ...
                  loss_weights={'decoder1_output': args.weight,
                                'decoder2_output': args.weight,
                                'predictor_output': 1 - args.weight})
    # model.compile(optimizer='adam', loss='mse')
    try:
        keras.utils.plot_model(model, show_shapes=True, to_file='multitask_rnn.png')
    except:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default="data/model/model_joint.h5")
